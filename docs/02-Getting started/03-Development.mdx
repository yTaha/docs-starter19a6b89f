...
Run `docuo version` to creating or deleting a specified version in the corresponding document instance. [Read more](../editing-docs/managing-docs/docs-versioning.mdx) .
```bash example
...
Read more on [OpenAPI configuration](https://docuo.spreading.io/using-openapi/setup-openapi) .
